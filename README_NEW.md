...
BESS_Optimization/
│
├── data_fetch.py              # Downloads market data from ENTSO-E API
├── Update.py                  # Core simulation engine (quadratic optimization)
├── presentation_analysis.py   # Visualization and analysis scripts
│
├── market_data_2019_2025.csv  # Historical market data
├── arbitrage_summary_with_pt.csv      # Simulation results summary
├── simulation_decisions_with_pt.csv   # Hourly dispatch decisions
│
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/yourusername/BESS_Optimization.git
...
```
Downloads Day-Ahead prices from ENTSO-E for 2019-2024. Output: `market_data_2019_2025.csv`

### 2. Run Optimization
```bash
python Update.py
```
Executes the BESS arbitrage simulation for all scenarios. Uses parallel processing. Output: `arbitrage_summary_with_pt.csv`, `simulation_decisions_with_pt.csv`
